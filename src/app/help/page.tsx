...
export default function HelpCenterPage() {
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col antialiased md:pl-64">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-24 md:pb-8 pt-8 w-full max-w-md mx-auto text-center relative">
